...
public class SacredSiteMarker_OpMenu extends InteractiveCustomUIPage<SacredSiteMarker_OpMenu.BindingData> {
    ...
    public static class BindingData {
        ...
        public static final BuilderCodec<BindingData> CODEC = BuilderCodec.builder(BindingData.class, BindingData::new)
                .addField(new KeyedCodec<>("@NumberFielde973f82b", Codec.FLOAT),
                        (data, s) -> data.NumberFielde973f82b = s,
                        data -> data.NumberFielde973f82b)
                .addField(new KeyedCodec<>("@NumberField39d3c936", Codec.FLOAT),
                        (data, s) -> data.NumberField39d3c936 = s,
                        data -> data.NumberField39d3c936)
                .addField(new KeyedCodec<>("@NumberField260af0dd", Codec.FLOAT),
                        (data, s) -> data.NumberField260af0dd = s,
                        data -> data.NumberField260af0dd)
                .addField(new KeyedCodec<>("@NumberField31af9960", Codec.FLOAT),
                        (data, s) -> data.NumberField31af9960 = s,
                        data -> data.NumberField31af9960)
                .addField(new KeyedCodec<>("@NumberField035daaf7", Codec.FLOAT),
                        (data, s) -> data.NumberField035daaf7 = s,
                        data -> data.NumberField035daaf7)
                .addField(new KeyedCodec<>("@NumberField953f6c26", Codec.FLOAT),
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store,
        ...
        if (changed) {
            this.blockState.setSpawnPoint(Faction.HRE, new Vector3d(
                    data.NumberFielde973f82b != null ? data.NumberFielde973f82b
                            : this.blockState.getSpawnPoint(Faction.HRE).getX(),
                    data.NumberField39d3c936 != null ? data.NumberField39d3c936
                            : this.blockState.getSpawnPoint(Faction.HRE).getY(),
                    data.NumberField260af0dd != null ? data.NumberField260af0dd
                            : this.blockState.getSpawnPoint(Faction.HRE).getZ()));
            this.blockState.setSpawnPoint(Faction.OE, new Vector3d(
                    data.NumberField31af9960 != null ? data.NumberField31af9960
                            : this.blockState.getSpawnPoint(Faction.OE).getX(),
                    data.NumberField035daaf7 != null ? data.NumberField035daaf7
                            : this.blockState.getSpawnPoint(Faction.OE).getY(),
                    data.NumberField953f6c26 != null ? data.NumberField953f6c26
